...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const cards = document.querySelectorAll('.features__card, .benefits__card, .support__rating');
  cards.forEach(card => {
  ...
  pricingOptions.forEach(option => {
    option.addEventListener('click', function() {
      pricingOptions.forEach(opt => opt.classList.remove('pricing__option--active'));
